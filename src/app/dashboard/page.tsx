...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col antialiased text-slate-900 font-sans">
      ...
      <header className="backdrop-blur-2xl bg-white/85 border-b border-slate-200/60 sticky top-0 z-30 shadow-[0_4px_20px_rgba(0,0,0,0.02)] pt-[max(env(safe-area-inset-top),1.25rem)] pb-1.5 sm:pb-2">
