...
export default function SignupPage() {
  ...
  return (
    <main className="min-h-[100dvh] bg-[#F8FAFC] flex flex-col justify-center py-10 sm:py-16 px-4 sm:px-6 lg:px-8 pt-[max(env(safe-area-inset-top),3rem)] pb-safe font-sans antialiased text-slate-900">
